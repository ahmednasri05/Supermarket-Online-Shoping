...
sqlite3* openDataBase(string dbFileName)
{
	...
	//Orders Table
	int reqOrder = sqlite3_exec(db, "CREATE TABLE IF NOT EXISTS orders (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, product_id INTEGER, quantity INTEGER, product_name TEXT, product_price INTEGER)", NULL, NULL, NULL);
